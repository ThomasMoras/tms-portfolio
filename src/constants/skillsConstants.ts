    ...
    techs: [
      {
        ...
        iconType: "code",
        color: "#007ACC",
        imgPath: "/images/tools/vscode.svg",
      },
      {
        name: "Cursor",
        iconType: "cursor-text",
        color: "#00BFFF",
        imgPath: "/images/tools/cursor.svg",
      },
      {
        name: "IntelliJ",
        iconType: "code",
        color: "#000000",
        imgPath: "/images/tools/intellij.svg",
      },
      {
        name: "GitHub",
        iconType: "github",
    ...
    techs: [
      {
        ...
        iconType: "ia",
        color: "#000000",
        imgPath: "/images/tools/claude.svg",
      },
      {
        name: "Notion",
        iconType: "file-text",
        color: "#000000",
        imgPath: "/images/tools/notion.svg",
      },
      {
        name: "Obsidian",
        iconType: "file-text",
        color: "#483699",
        imgPath: "/images/tools/obsidian.svg",
      },
      {
        name: "Postman",
        iconType: "send",
        color: "#FF6C37",
        imgPath: "/images/tools/postman.svg",
      },
      {
        name: "Power BI",
        iconType: "bar-chart",
        color: "#F2C811",
        imgPath: "/images/tools/power-bi.svg",
      },
      {
        name: "MS Office Suite",
        iconType: "file",
        color: "#0078D4",
        imgPath: "/images/tools/ms-office.svg",
      },
    ],
  },
  {
    ...
    techs: [
      ...
      },
      {
        ...
        iconType: "server",
        color: "#009639",
        imgPath: "/images/tools/vercel.svg",
      },
      {
        name: "Jenkins",
        iconType: "server",
        color: "#D24939",
        imgPath: "/images/tools/jenkins.svg",
      },
      {
        name: "Maven",
        iconType: "package",
        color: "#C71A36",
        imgPath: "/images/tools/maven.svg",
      },
      {
        name: "Nginx",
        iconType: "server",
...
export const CERTIFICATIONS: CertificationCategory[] = [
  {
    ...
    techs: [
      {
        name: {
          en: "Information systems expert",
          fr: "Expert en systèmes d'informations",
        },
        school: {
          en: "Isitech Partner Formation",
          fr: "Isitech Partner Formation",
        },
        schoolUrl: "https://www.ecole-isitech.com",
        link: "https://www.ecole-isitech.com/formations/mastere-esi/",
        img: "/images/certifications/isitech.png",
        learning: false,
        complete: "2019",
      },
    ],
